...
func effectiveLabels(labels []string, result triageResult) []string {
	out := filterLabels(labels, func(l string) bool { return !slices.Contains(result.LabelsToRemove, l) })
