...
func (in *IstioDriverConfig) DeepCopyInto(out *IstioDriverConfig) {
	*out = *in
	...
	if in.DynamicModule != nil {
		...
		*out = new(IstioDynamicModuleConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IstioDynamicModuleConfig) DeepCopyInto(out *IstioDynamicModuleConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IstioDynamicModuleConfig.
func (in *IstioDynamicModuleConfig) DeepCopy() *IstioDynamicModuleConfig {
	if in == nil {
		return nil
	}
	out := new(IstioDynamicModuleConfig)
