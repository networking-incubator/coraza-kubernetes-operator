...
func TestEngineReconciler_BuildEnvoyFilter_BasicStructure(t *testing.T) {
	...
	require.True(t, ok)
	assert.Equal(t, "gateway", labels["app"])
...
func TestEngineReconciler_BuildEnvoyFilter_IstioRevisionLabel(t *testing.T) {
	engine := utils.NewTestDynamicModuleEngine(utils.DynamicModuleEngineOptions{
		Name:      "rev-test",
		Namespace: testNamespace,
	})
...
func TestEngineReconciler_BuildEnvoyFilter_RulesEmbedded(t *testing.T) {
	engine := utils.NewTestDynamicModuleEngine(utils.DynamicModuleEngineOptions{
		Name:      "rules-test",
		Namespace: testNamespace,
	})
...
func TestEngineReconciler_BuildEnvoyFilter_FilterModes(t *testing.T) {
	tests := []struct {
...
func TestEngineReconciler_BuildEnvoyFilter_CustomModuleAndFilter(t *testing.T) {
	engine := utils.NewTestDynamicModuleEngine(utils.DynamicModuleEngineOptions{
		Name:       "custom-names",
		Namespace:  testNamespace,
...
func TestEngineReconciler_BuildDynamicModuleFilterConfig(t *testing.T) {
...
func TestEngineReconciler_DynamicModule_RulesNotCached(t *testing.T) {
...
func TestEngineReconciler_DynamicModule_Provisioning(t *testing.T) {
	ctx := context.Background()
...
func TestEngineReconciler_BuildDynamicModuleConfigMap(t *testing.T) {
	t.Run("default module name", func(t *testing.T) {
		...
		// Two init containers: dm-tools-init (busybox) + dynamic-module-init (module image)
	...
	t.Run("no proxy image by default", func(t *testing.T) {
		...
		cm := buildDynamicModuleConfigMap(engine)
		overlay := cm.Data["deployment"]
		assert.NotContains(t, overlay, "image: envoyproxy")
	})
...
func TestEngineReconciler_DynamicModule_ConfigMapCreated(t *testing.T) {
	ctx := context.Background()
...
func TestEngineReconciler_DynamicModule_NoConfigMapWithoutImage(t *testing.T) {
	ctx := context.Background()
